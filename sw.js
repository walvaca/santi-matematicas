/* Service Worker de Súper Santi — permite abrir la app sin conexión a internet.
...
const CACHE_NAME = 'super-santi-v7';
const ASSETS = [
  './', './index.html', './manifest.json', './icon-192.png', './icon-512.png',
  './js/progreso.js', './js/mundos.js', './js/mascota.js', './js/sonido.js',
  './js/generadores.js', './js/lecciones.js', './js/juego.js', './js/arcade.js',
  './js/ui.js', './js/app.js'
];
